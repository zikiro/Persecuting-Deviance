...
public class EvidenceSpawn : MonoBehaviour {
    ...
    public Vector3 evidencePos = new Vector3();
    ...
    void Start () {
        ...
        evidencePos.x = Random.Range(minPosx, maxPosx);
       ...
       itemSpawn = Random.Range(0, 2);
        ...
        if (itemSpawn == 1)
        {
            Instantiate(evidence, evidencePos, Quaternion.identity);
        }
